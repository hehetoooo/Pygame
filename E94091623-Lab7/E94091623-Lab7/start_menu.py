...
class StartMenu:
    def __init__(self):
        ...
        # background
        self.bg = pygame.transform.scale(pygame.image.load(os.path.join("images", "start_menu.png")),
        ...
        while run:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    elif self.sound_btn.clicked(x, y):   # check if hit sound btn
                        pygame.mixer.music.unpause()     # continue to play the music
                    elif self.mute_btn.clicked(x, y):    # check if mute sound btn
