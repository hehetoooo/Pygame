...
class Tower:
    ...
    def PCR(cls, x: int, y: int):
        ...
        :return: object
        """
        pcr = cls(x, y, Snipe(), PCR_IMAGE)  # Set PCR position, attack mode, picture
        pcr.cd_max_count = 120  # Set the attack time interval to 120
        pcr._range = [100, 105, 110, 115, 120, 125]  # Set attack range
        pcr._damage = [3.0, 3.2, 3.4, 3.6, 3.8, 4.0]  # Set damage
        return pcr
